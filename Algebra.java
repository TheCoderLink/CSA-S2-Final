public class Algebra extends Math {
  ...
  //class constructor
  public Algebra(String name, int gradeLevel, int age, int roomNo, String textBookName) {
  ...
  {
    super.stringIntro();
    System.out.println("I teach an Algebra class, and the textbook that I use is " + textBookName + ".\n");
  }
